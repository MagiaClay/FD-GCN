...
class Processor():
    ...
    def train(self, epoch, save_model=False):
        ...
        for batch_idx, (joint_data, bone_data, label, index) in enumerate(process):
            ...
            data = torch.stack((joint_data, bone_data), dim=1)
            ...
            # print(data.shape)  # [64,2, 3, 300, 25, 2]
            # forward
    ...
    def eval(self, epoch, save_score=False, loader_name=['test'], wrong_file=None, result_file=None):
        ...
        for ln in loader_name:
            ...
            for batch_idx, (joint_data, bone_data, label, index) in enumerate(process):
                data = np.stack(
                    (joint_data.numpy(), bone_data.numpy()), axis=1)
                with torch.no_grad():
    ...
    def plot_metrics(self):
        ...
        # axs[1, 1].plot(range(len(self.lr_values)),
        #                self.lr_values, label='Learning Rate')
