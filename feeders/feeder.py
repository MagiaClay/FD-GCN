...
class Feeder(Dataset):
    def __init__(self, joint_data_path, bone_data_path, label_path,
        ...
        self.joint_dataset = BaseDataset(joint_data_path, label_path, random_choose,
                                         random_shift, random_move, window_size, normalization, debug, use_mmap)
        self.bone_dataset = BaseDataset(bone_data_path, label_path, random_choose,
                                        random_shift, random_move, window_size, normalization, debug, use_mmap)
